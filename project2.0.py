...
frame2 = Frame(root, width=320, height=230, background="#2F2F2F") #default color was #D3D3D3

#ФРЕЙМ ДЛЯ НОРМАЛЬНОГО РАСПОЛОЖЕНИЯ КНОПОК
frame3 = Frame(root, width=320, height=160, background="#2F2F2F")
...
button_add = Button(frame3, text="Добавить", width=10, command=add, bg='#474747', fg='white',
                    activebackground='#BFB173', relief='raised')
#button_add.grid(row=4,column=1, pady=1)
button_add.place(x=50, y=10)

button_delete = Button(frame3, text="Удалить задачу", command=delete_task, bg='#474747', fg='white',
                    activebackground='#BFB173', relief='raised')
#button_delete.grid(row=5, column=1)
button_delete.place(x=45, y=40)

button_filter = Button(frame3, text="Фильтр задач", command=filter_tasks, bg='#474747', fg='white',
                    activebackground='#BFB173', relief='raised')
...
button_exit = Button(frame3, text="Выход", width=8, command=exit,  bg='#474747', fg='white',
